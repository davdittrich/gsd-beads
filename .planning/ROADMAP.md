...
- [x] 03-03-PLAN.md — Machine-local patch to gsd-core's ship.md making the ship:pre gates/step dispatch live, plus a self-detecting reapply check (B9, B10)
...
- [x] 04-01-PLAN.md — One-shot todo migration: parse `.planning/todos/pending/`, map to bd priority/label/description, non-destructive on parse failure (B12)
